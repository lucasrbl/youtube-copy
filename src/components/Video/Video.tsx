...
import { formatTimeAgo } from './utils/formatTimeAgo/formatTimeAgo';
import { viewFormatter } from './utils/viewFormatter/viewFormatter';
type VideoPropsType = {
    id: string
    title: string
    channel: {
...
function Video({ channel, duration, id, postedAt, thumbnailUrl, title, videoUrl, views}: VideoPropsType) {
